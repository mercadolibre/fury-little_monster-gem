...
require 'little_monster/core/errors/job_class_not_found_error'
...
require 'little_monster/core/errors/attributes_not_found_error'
...
require 'little_monster/core/worker_id'
